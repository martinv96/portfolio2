 ...
 */
final class Version20241107154551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE description description VARCHAR(1000) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
